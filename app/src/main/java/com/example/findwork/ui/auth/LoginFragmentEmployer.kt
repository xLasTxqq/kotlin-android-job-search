...
import com.example.findwork.databinding.FragmentLoginEmployerBinding
import com.example.findwork.ui.data.VolleyRequest
import org.json.JSONObject


class LoginFragmentEmployer : Fragment(),VolleyRequest.Listener {

    private lateinit var binding: FragmentLoginEmployerBinding
    private val dataModel: DataAuthViewModel by activityViewModels()
    private val url: String = "https://thisistesttoo.000webhostapp.com/api/login/employer"
    ...
    override fun onCreateView(
        ...
        binding = FragmentLoginEmployerBinding.inflate(inflater , container , false)
        ...
        binding.apply {
            ...
            submit.setOnClickListener {
                ...
                updateBodyRequest()
                VolleyRequest(this@LoginFragmentEmployer).sendRequest(url, Request.Method.POST, dataModel.bodyRequest.value?.getJSONObject(url), false)
            }
